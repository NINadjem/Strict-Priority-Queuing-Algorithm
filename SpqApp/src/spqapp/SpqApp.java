...
public class SpqApp {
    ...
    public static void main(String[] args) {
       ...
       // 2eme exemple 
        ...
        wList = new ArrayList<>();
        wList.add('b');
        inputList.add(new SPQ.InputElement(4.5, wList));
        ...
        wList.add('b');
        wList.add('c');
        inputList.add(new SPQ.InputElement(6, wList));
       new SPQ(inputList).printTheResult();*/
       ...
       /* ArrayList<SPQ.InputElement> inputList = new ArrayList();
        ...
        wList.add('a');
        wList.add('c');
        inputList.add(new SPQ.InputElement(2.5, wList));
        ...
        wList.add('a');
        wList.add('b');
        inputList.add(new SPQ.InputElement(6.5, wList));
